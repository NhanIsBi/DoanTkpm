...
public class SinhVienThongKe extends JFrame {
	...
	private static PieDataset createDataset() {
        ...
        dataset.setValue("Nam-Số lượng :"+(int)demnam, new Double(ptnam));
        dataset.setValue("Nữ-Số lượng :"+(int)demnu, new Double(ptnnu));
        return dataset;
    }
